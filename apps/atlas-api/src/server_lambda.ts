...
import { createContext, initializeForLambda, useLambdaRuntime } from './context';
...
export const handler = async (
  ...
  // tRPC handler - reads event.rawPath like "/atlas/listEntities" and supports batching via ?batch=1
