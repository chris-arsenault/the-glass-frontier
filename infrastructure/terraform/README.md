...
- **Lambda** functions for the Chronicle API, GM API, and supporting services.
...
1. Build the client plus the chronicle and GM APIs via `pnpm`.
...
- `client_build_command`, `chronicle_api_build_command`, `gm_api_build_command`
