...
## Next Steps & Risks
- Wire Temporal contest workflow resolutions back into hub state once backend emits outcome tiers/complications; update UI/docs to display resolved results.
