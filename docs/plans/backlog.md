...
| IMP-CLIENT: Unified Web Client Shell | IMP-CLIENT-07: Contest & Publishing Overlays Unification | in-progress | P1 | Contest timeline + stage badges refreshed with Temporal naming; sentiment auto-refresh now wired, awaiting SME copy review and staging validation before close. |
