...
| IMP-CLIENT: Unified Web Client Shell | IMP-CLIENT-07: Contest & Publishing Overlays Unification | in-progress | P1 | Sentiment auto-refresh wired with Playwright coverage; SME copy brief + stage terminology handoff drafted; awaiting SME feedback and live telemetry validation before close. |
