...
| IMP-CLIENT: Unified Web Client Shell | IMP-CLIENT-07: Contest & Publishing Overlays Unification | in-progress | P1 | Sentiment auto-refresh validated with sentence-driven copy and context-aware CTA; SME feedback incorporated; staging telemetry validation remains before close. |
