...
| IMP-CLIENT: Unified Web Client Shell | **IMP-CLIENT-06: Narrative Overlay & Pipeline Status Integration** | ready-for-review | P1 | phase:implementation, pillar:client | Success check overlay now exposes dice/modifiers/momentum, traits & relationships surface from session memory, and admins receive live pipeline job/alert dashboards. |
