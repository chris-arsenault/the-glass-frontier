...
| IMP-HUBS: Hub Implementation & Load Readiness | IMP-HUBS-05: Hub PvP Contested Interactions | in-progress | P1 | Rematch offers now gate timeout retries with verb-level cooldowns, and timeout expirations apply multi-actor momentum penalties; next focus is cooldown telemetry review and sentiment monitoring around the refreshed duel loop. |
