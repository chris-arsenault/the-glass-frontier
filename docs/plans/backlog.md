...
| IMP-CLIENT: Unified Web Client Shell | IMP-CLIENT-07: Contest & Publishing Overlays Unification | ready-for-review | P1 | Cooldown polling validated against staged IMP-HUBS-05 sentiment; copy/CTA transitions locked by Jest and artefacted (`artifacts/client/contest-sentiment-staging-2025-11-05T10-26-22Z.md`). |
