...
| IMP-CLIENT: Unified Web Client Shell | IMP-CLIENT-01: Web Client Shell & Chat Canvas | todo | P1 | phase:implementation, pillar:client | React/Vite shell with chat-first UX and accessibility scaffolding. |
