...
| IMP-HUBS: Hub Implementation & Load Readiness | IMP-HUBS-05: Hub PvP Contested Interactions | in-progress | P1 | Contest coordinator + duel verb landed; hook Temporal outcomes and moderation evidence next. |
