...
| IMP-CLIENT: Unified Web Client Shell | IMP-CLIENT-07: Contest & Publishing Overlays Unification | in-progress | P1 | Contest timeline + stage badges refreshed with Temporal naming; microcopy updated, waiting on SME feedback and live sentiment validation to close. |
