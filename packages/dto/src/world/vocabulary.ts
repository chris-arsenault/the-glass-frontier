...
const RELATIONSHIP_TYPE_DEFS = [
  ...
  { category: 'social', defaultStrength: 0.6, description: 'A current or former bearer holds a named mantle or designation.', id: 'bears' },
...
const WORLD_TAG_DEFS = [
  ...
  { description: 'Bloom containment and displacement: zones, cordons, recoveries and their history', id: 'subject_bloom' },
  { description: 'Shared everyday knowledge: peoples, tools, materials, household customs and general craft', id: 'subject_common_life' },
  { description: 'Hab life: independent ring communities, local customs, work and ecology', id: 'subject_hab_life' },
  { description: 'Istravan war and coastal life: occupation, resistance, refuges and regional history', id: 'subject_istrava' },
  { description: 'Journeys and trade: travel, shipping, communications, carriers and shared rescue', id: 'subject_journeys_trade' },
  { description: 'Lithren exploration: Ithara, satellite ruins, expeditions and recovered ancient history', id: 'subject_lithren' },
  { description: 'Planetary life: surface and outer-world settlements, landscapes and local ecology', id: 'subject_planetary_life' },
  { description: 'Public life and history: wider institutions, law, archives, war and peace', id: 'subject_politics_history' },
  { description: 'Resonance and cosmology: field physics, spellwork, mantles, religion and elven mysteries', id: 'subject_resonance' },
  { description: 'Shear salvage and wilderness: claims, crews, extraction, wrecks and native hazards', id: 'subject_shear' },
