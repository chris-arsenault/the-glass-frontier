...
const KIND_DEFS = [
  ...
  },
  {
    ...
    id: 'creature',
    statuses: ['alive', 'dead', 'extinct', 'dormant'],
    subkinds: ['beast', 'predator', 'swarm', 'leviathan', 'construct', 'spirit'],
  },
  {
    category: 'real',
...
const RELATIONSHIP_TYPE_DEFS = [
  ...
  { category: 'social', defaultStrength: 0.6, description: 'Subject creature preys on the target creature or NPC.', id: 'preys_on' },
  ...
  { category: 'causal', defaultStrength: 0.8, description: 'Subject NPC, faction, or faith actively seeks the target artifact, resource, creature, or magic.', id: 'seeks' },
  { category: 'causal', defaultStrength: 0.6, description: 'Subject location, creature, or resource is the origin or source of the target resource or magic.', id: 'source_of' },
...
> = {
  ...
  npc: {
    artifact: ['wields', 'seeks'],
    conflict: ['fights_in', 'cause_of'],
    creature: ['studies', 'seeks', 'ally_of', 'enemy_of'],
