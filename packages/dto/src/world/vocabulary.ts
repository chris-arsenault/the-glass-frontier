...
const RELATIONSHIP_TYPE_DEFS = [
  ...
  { category: 'spatial', defaultStrength: 0.6, description: 'Subject NPC normally lives in the target location.', id: 'resides_in' },
  { category: 'spatial', defaultStrength: 0.4, description: 'Subject NPC regularly visits the target location.', id: 'frequents' },
  { category: 'spatial', defaultStrength: 0.5, description: 'Subject NPC works at the target location.', id: 'works_at' },
  { category: 'spatial', defaultStrength: 0.4, description: 'Subject location is inhabited by the target NPC or group.', id: 'inhabited_by' },
  ...
  { category: 'doctrinal', defaultStrength: 0.6, description: 'Subject NPC, faction, or faith studies the target magic, resource, artifact, or phenomenon.', id: 'studies' },
