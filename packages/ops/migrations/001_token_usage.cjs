...
exports.up = (pgm) => {
  ...
  pgm.addConstraint('token_usage', 'token_usage_pk', {
    primaryKey: ['player_id', 'usage_period'],
  });
  pgm.createIndex('token_usage', 'player_id', { name: 'token_usage_player_idx' });
  pgm.createIndex('token_usage', ['player_id', 'usage_period'], {
    name: 'token_usage_period_idx',
  });
};

exports.down = (pgm) => {
  pgm.dropIndex('token_usage', ['player_id', 'usage_period'], {
    ifExists: true,
    name: 'token_usage_period_idx',
  });
  pgm.dropIndex('token_usage', 'player_id', { ifExists: true, name: 'token_usage_player_idx' });
